...
const userRoutes = [
  ...
  {
    path: routesConfig.listBooks,
    component: BooksList,
    layout: null,
    title: "Tủ sách",
  },
  {
    path: routesConfig.bookDetail,
    component: BookDetail,
    layout: null,
    title: "Chi tiết về sách",
  },
  {
    path: routesConfig.address,
    component: LibraryAddress,
    layout: null,
    title: "Địa chỉ",
  },
  {
    path: routesConfig.handmadeItem,
    component: HandmadeItems,
    layout: null,
    title: "Tiệm hand",
  },
  {
    path: routesConfig.borrowerCard,
  ...
  {
    path: routesConfig.borrowerSlips,
    component: BorrowerSlips,
    layout: null,
    title: "Phiếu mượn của bạn đọc",
  },
  {
  ...
  {
    path: routesConfig.notfound404user,
...
const adminRoutes = [
  ...
  {
    path: routesConfig.bookListAdmin,
    component: BookList,
    title: "Quản lý sách",
  },
  {
    path: routesConfig.onSlipAdmin,
    component: OnBorrowerSlip,
    title: "Quản lý phiếu mượn sách On",
  },
  {
    path: routesConfig.offSlipAdmin,
    component: OffBorrowerSlip,
    title: "Quản lý phiếu mượn sách Off",
  },
  {
    path: routesConfig.borrowerListAdmin,
    component: BorrowerList,
    title: "Quản lý tài khoản bạn đọc",
  },
  ...
  {
    path: routesConfig.notfound404admin,
    component: NotFound404,
